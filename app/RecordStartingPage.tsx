		...
		<SafeAreaView style={styles.container}>
			<ScrollView style={styles.scrollView}>
				...
				<View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginHorizontal: 22, marginBottom: 240, marginTop: 200 }}>
					{isPaused ? (
						// Render static line image when paused
						<Image
			...
			<View style={styles.controlsContainer}>
				...
				<TouchableOpacity onPress={togglePausePlay}>
					<Image
						source={
							isPaused
								? require("../assets/images/play.png") // Display play icon if paused
								: require("../assets/images/pause.png") // Display pause icon if running
						}
						resizeMode="stretch"
